...
b_menu = Button("MENU", fontColor, 50, position_b1, image_boutton, image_bout_press, white)		# End Menu
b_win = Button("YOU WIN !", green, fontSize, (150, 150), image_boutton, image_boutton, white)		# End Win
b_lose = Button("YOU LOSE...", red, fontSize, (150, 150), image_boutton, image_boutton, white)	# End Lose
